...
/*if(vm.filter.selectionMode == 'multiple'){
    ...
    `}),visitorModal=Vue.component("vi-date-filter",{props:["filter"],data:()=>({date:null}),methods:{},watch:{date:function(a){let b=this;b.filter.filterValue=a.valueOf()}},computed:{},mounted:async function(){this},template:`
